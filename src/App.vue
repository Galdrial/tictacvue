    ...
    <main class="flex-1">
      ...
      <div class="flex flex-col items-center font-sans text-gray-800 py-8">
        ...
        <template v-else>
          ...
          >
            <div
              class="col-span-3 row-span-3 w-full h-full flex flex-col items-start justify-center text-white text-lg font-['Press_Start_2P'] text-left"
            >
              Instructions:
              <div class="h-4"></div>
              Enter the player names and press Start to begin the
              game.
              <div class="h-4"></div>
